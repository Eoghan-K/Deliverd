...
public class Signup_vendor extends AppCompatActivity {
        ...
        if (email.getText().toString().equals("") || password.getText().toString().equals("")){
            ...
            user.signUpInBackground(new SignUpCallback() {
                ...
                public void done(ParseException e) {
                    if (e == null){
                        Toast.makeText(Signup_vendor.this, "Sign Up Successful", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(Signup_vendor.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
